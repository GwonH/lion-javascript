...
// console.log(friends.length = 3); 이러면 다 짤려서 쓰지마! 위험해! 
// = 0 해서 배열을 비울땐 쓰긴 함.
...
// 배열 요소 제거
let shift = friends.shift(); //제거가 된 대상(앞요소)이 담김
console.log(friends);

let pop = friends.pop(); //제거가 된 대상(뒷요소)이 담김
console.log(friends);
