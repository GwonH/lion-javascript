...
function first(){
  ...
  return second()    //함수를 실행해서 second의 결과값을 받는다.
}
...
function first(){
  ...
  return second    //함수 본문 내보내기
}

// currying function
first()() //15 .  first()(second의parameter자리로)
// 뒤에 함수는 second 함수. 근데 이렇게 안 씀 읽기가 불편해서.
// 어디에 담아서 많이 쓴다.
const value = first()
value() //이렇게 본문 담겨서 함수처럼 쓴다.
